...
if selected == 'Heart Disease Prediction':
    ...
    if st.button('Heart Disease Test Result'):
        ...
        if heart_disease_model:
            ...
            st.error("Heart disease model not loaded correctly! Check the error message above for details.")
...
# Liver Disease Prediction
    ...
    Diagnosis = st.selectbox('Diagnosis (0, 1, 2)', [0, 1, 2]) # Consider if this is a feature or the target. If target, it shouldn't be an input.
    ...
    if st.button('Liver Disease Test Result'):
        ...
        if liver_disease_model:
            ...
            st.error("Liver disease model not loaded correctly! Check the error message above for details.")
...
# Exploratory Data Analysis
    ...
    # Use the defined relative paths (filenames directly)
